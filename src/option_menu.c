...
#define tBattleWindowFrame data[3]
...
#define YPOS_BATTLEWINDOWFRAME  (MENUITEM_BATTLEWINDOWFRAME * 16)
...
static u8 BattleWindowFrame_ProcessInput(u8 selection);
static void BattleWindowFrame_DrawChoices(u8 selection);
...
static const u8 *const sOptionMenuItemsNames[MENUITEM_COUNT] =
{
    ...
    [MENUITEM_BATTLEWINDOWFRAME] = gText_BattleWindowFrame,
...
void CB2_InitOptionMenu(void)
{
    ...
    case 10:
    {
        ...
        gTasks[taskId].tBattleWindowFrame = gSaveBlock2Ptr->optionsBattleWindowFrame;
        ...
        BattleWindowFrame_DrawChoices(gTasks[taskId].tBattleWindowFrame);
    ...
    else
    {
        ...
        case MENUITEM_BATTLESCENE:
            ...
            if (previousOption != gTasks[taskId].tBattleSceneOff)
                BattleScene_DrawChoices(gTasks[taskId].tBattleSceneOff);
            break;
        case MENUITEM_BATTLEWINDOWFRAME:
            previousOption = gTasks[taskId].tBattleWindowFrame;
            gTasks[taskId].tBattleWindowFrame = BattleWindowFrame_ProcessInput(gTasks[taskId].tBattleWindowFrame);

            if (previousOption != gTasks[taskId].tBattleWindowFrame)
                BattleWindowFrame_DrawChoices(gTasks[taskId].tBattleWindowFrame);
            break;
        case MENUITEM_SOUND:
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->optionsBattleWindowFrame = gTasks[taskId].tBattleWindowFrame;
...
static void BattleWindowFrame_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_BattleWindowFrameRojo, 104, YPOS_BATTLEWINDOWFRAME, styles[0]);
    DrawOptionMenuChoice(gText_BattleWindowFrameNegro, GetStringRightAlignXOffset(FONT_NORMAL, gText_BattleWindowFrameNegro, 198), YPOS_BATTLEWINDOWFRAME, styles[1]);
}
