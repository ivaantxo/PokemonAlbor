...
const u8 gText_BattleWindowFrame[] = _("Color");
const u8 gText_BattleWindowFrameRojo[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Rojo");
const u8 gText_BattleWindowFrameNegro[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Negro");
